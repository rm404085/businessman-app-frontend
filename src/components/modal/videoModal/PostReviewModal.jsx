...
const PostReviewModal = ({ setOpenPostReview }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center md:justify-center"
      onClick={(e) => {
        e.stopPropagation();
        setOpenPostReview(false);
      }}
    >
      ...
      >
        ...
        <div onClick={(e) => e.stopPropagation()}>
          <div className="flex justify-between gap-3">
            ...
            <div>
              <label
                onClick={(e) => e.stopPropagation()}
                className="cursor-pointer flex items-center gap-2 text-green-600 hover:opacity-80 transition"
              >
                <IoImage size={30} />
        ...
        {mediaPreview.length > 0 && (
          <div
            className="mt-4 grid grid-cols-3 md:grid-cols-2 gap-3"
            onClick={(e) => e.stopPropagation()}
          >
        ...
        >
          <div className="flex items-center py-4 border-violet-200 rounded-lg border px-2 justify-between">
            ...
            <div className="flex gap-3">
              <button
                className="text-yellow-500 hover:opacity-80 transition"
                onClick={(e) => e.stopPropagation()}
              >
                😊
              </button>
              ...
              <button
                className="text-indigo-500 hover:opacity-80 transition"
                onClick={(e) => e.stopPropagation()}
              >
                📍
              </button>
          ...
          <button
            ...
            className="w-full mt-4 bg-blue-600 text-white py-2.5 rounded-xl font-semibold hover:bg-blue-700 transition"
          >
            Post
          </button>
          ...
          <div
            className="mt-4 flex flex-wrap gap-3 md:hidden"
            onClick={(e) => e.stopPropagation()}
          >
